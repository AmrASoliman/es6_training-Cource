(function(global, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(
      exports,
      module,
      require('formula-isnumber'),
      require('formula-errors')
    );
  } else {
    var mod = {
      exports: {}
  ...
  function PMT(rate, periods, present) {
    ...
    var type =
      arguments.length <= 4 || arguments[4] === undefined ? 0 : arguments[4];

    if (
      !(0, _isnumber['default'])(rate) ||
      !(0, _isnumber['default'])(periods)
    ) {
